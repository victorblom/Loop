...
final class BolusViewController: UITableViewController, IdentifiableClass, UITextFieldDelegate {
    ...
    var superBolusRecommendation: BolusRecommendation? = nil {
        didSet {
            ...
            recommendedSuperBolusDescription = String(format: NSLocalizedString("Suggested Super Bolus: %@", comment: "The string format describing super bolus amount. (1: localized super bolus amount description)"), sbStr)
        }
    }
